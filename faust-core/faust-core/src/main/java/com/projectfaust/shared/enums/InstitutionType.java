...
public enum InstitutionType {
    ...
    /**
     * Entitie operating within the state level
     * Includes international, national level..
     */
    SOVEREIGN( "STATE", "State, International Organization"),

    /**
     * State-owned enterprises (SOEs).
     * Entities like Ceska posta, DPP, or municipal utility companies.
     */
    STATE_ENTERPRISE("SE", "State Enterprise");
